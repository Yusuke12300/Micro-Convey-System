# Python stubs generated by omniidl from InterfaceDataTypes.idl
...
#
__name__ = "RTC"
_0_RTC = omniORB.openModule("RTC", r"InterfaceDataTypes.idl")
_0_RTC__POA = omniORB.openModule("RTC__POA", r"InterfaceDataTypes.idl")
