# Python stubs generated by omniidl from ExtendedDataTypes.idl
...
#
__name__ = "RTC"
_0_RTC = omniORB.openModule("RTC", r"ExtendedDataTypes.idl")
_0_RTC__POA = omniORB.openModule("RTC__POA", r"ExtendedDataTypes.idl")
