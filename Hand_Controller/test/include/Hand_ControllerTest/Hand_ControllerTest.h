...
/*!
 * @file  Hand_ControllerTest.h
 * @brief ModuleDescription (test code)
 *
 */
// </rtc-template>

#ifndef HAND_CONTROLLER_TEST_H
#define HAND_CONTROLLER_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  Hand_ControllerTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~Hand_ControllerTest() override;
 ...
 protected:
  ...
  /*!
   */
  RTC::InPort<RTC::TimedBoolean> m_hand_endIn;
  ...
  /*!
   */
  RTC::OutPort<RTC::TimedBoolean> m_hand_releaseOut;
...
extern "C"
{
  DLL_EXPORT void Hand_ControllerTestInit(RTC::Manager* manager);
};

#endif // HAND_CONTROLLER_TEST_H
