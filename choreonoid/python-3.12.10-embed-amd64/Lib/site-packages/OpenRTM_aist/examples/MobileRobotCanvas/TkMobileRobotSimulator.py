...
class PropertyDialog:
    ...
    def pack(self):
        ...
        if self.apply_param is not None:
        ...
        if self.reset_output is not None:
...
class DDMobileRobot(SimulatedObject):
    ...
    def __init__(self, simulator, radius=2, wheeld=20,
        ...
        self.comp = OpenRTM_aist.Manager.instance(
        ).createComponent("TkMobileRobotSimulator")
    ...
    def property_page(self):
        ...
        p.append_input(
            "Angular velocity (LEFT)  wl: ",
            self.wlentry,
            "[rad/s]")
        p.append_input(
            "Angular velocity (RIGHT) wr: ",
            self.wrentry,
            "[rad/s]")
