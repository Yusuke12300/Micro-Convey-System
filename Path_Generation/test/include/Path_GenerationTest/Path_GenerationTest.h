...
/*!
 * @file  Path_GenerationTest.h
 * @brief Serve serve, reserve bumper (test code)
 *
 */
// </rtc-template>

#ifndef PATH_GENERATION_TEST__H
#define PATH_GENERATION_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  Path_GenerationTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~Path_GenerationTest() override;
...
extern "C"
{
  DLL_EXPORT void Path_GenerationTestInit(RTC::Manager* manager);
};

#endif // PATH_GENERATION_TEST_H
