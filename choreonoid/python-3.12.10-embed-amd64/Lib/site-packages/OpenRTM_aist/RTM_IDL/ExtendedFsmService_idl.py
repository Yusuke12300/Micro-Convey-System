# Python stubs generated by omniidl from ExtendedFsmService.idl
...
#
__name__ = "RTC"
_0_RTC = omniORB.openModule("RTC", r"ExtendedFsmService.idl")
_0_RTC__POA = omniORB.openModule("RTC__POA", r"ExtendedFsmService.idl")
