...
import OpenRTM_aist.CSPMachine as CSPMachine
import OpenRTM_aist.CSPEventPort as CSPEventPort
...
class Microwave(OpenRTM_aist.DataFlowComponentBase):
    ...
    def onInitialize(self):
        ...
        self._eventIn = CSPEventPort.CSPEventPort(
            "event", self._fsm, self._cspmanager)
        ...
        self._eventIn.bindEvent1(
            "minute",
            MicrowaveFsm.TOP.minute,
            RTC.TimedLong(
                RTC.Time(
                    0,
                    0),
