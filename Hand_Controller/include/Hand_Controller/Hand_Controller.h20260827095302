  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  Hand_Controller(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~Hand_Controller() override;
 ...
 protected:
  ...
  /*!
   */
  RTC::OutPort<RTC::TimedBoolean> m_hand_endOut;
...
extern "C"
{
  DLL_EXPORT void Hand_ControllerInit(RTC::Manager* manager);
};
