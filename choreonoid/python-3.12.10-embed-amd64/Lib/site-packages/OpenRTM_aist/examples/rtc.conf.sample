...
manager.components.precreate: <component name>
#   If you want to activate #0 instance
manager.components.preactivation: <component name>0
...
#
# <component_category>.<component_name>.config_file: <component_name>.conf
# or
# <component_category>.<component_name>.config_file: <component_name>0.conf
# <component_category>.<component_name>.config_file: <component_name>1.conf
# <component_category>.<component_name>.config_file: <component_name>2.conf
